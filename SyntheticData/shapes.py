...
class Shape:
  def __init__(self, origin, origin_color, n_nodes, origin_community=0):
      self.origin = origin
      ...
      self.community_colours = [origin_community] * n_nodes
...
class Diamond(Shape):
    ...
    def __init__(self, origin, origin_color, origin_community=0):
...
House(0,0).draw(colour_by="label")
...
class Tree(Shape):
    ...
    def __init__(self, origin, origin_color,n_levels=2, n_children=2,
                 origin_community=0,
                 ):
        ...
        for l in range(0, n_levels):
            ...
            for nn in range(0, n_children**l):
                ...
                self.community_colours += [a + nn] * (n_children)
                b += n_children
            a += n_children**l 
